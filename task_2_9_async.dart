// Задание 1
// Используя Future, загрузите текстовый файл с ресурса
// "https://jsonplaceholder.typicode.com/posts" или любой другой страницы
// с текстовыми данными. Для загрузки текста не обязательно использовать json
// парсинг данных. Можно представить данные в виде набора байт и декодировать
// при помощи utf8 декодера. Пример ...

// Загрузите картинку с ресурса
// "https://i.pinimg.com/564x/e6/57/1a/e6571a6c62fb2615c741a8fcf32aef49.jpg".
// Для загрузки изображений в виде файла можно использовать следующий код
...
// Обрабатывать ошибки не обязательно. Это будет пройдено в "Продвинутое
// изучение Future"
